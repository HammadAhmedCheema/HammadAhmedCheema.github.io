...
![alt text](/static/images/demon-1.png)

lets run and see what it do

![alt text](/static/images/demon-2.png)
...
![alt text](/static/images/demon-3.png)
...
![alt text](/static/images/demon-4.png)
...
![alt text](/static/images/demon-5.png)

#### knight_Attack

![alt text](/static/images/demon-6.png)
...
- we first have to loose once to from "Siegwurm" and then chose wizrd to fight the "Wezaemon" , then we can use mizup of cloak and booster to overflow the hp of the Wezaemon (as it is stored in one byte)
  ...
  ![alt text](/static/images/demon-7.png)
...
but the works not end yet , after defeating the demon we free it's allocated memory and return and back in start fight_demon  
  ![alt text](/static/images/demon-8.png)
...
![alt text](/static/images/demon-9.png)
...
![alt text](/static/images/demon-10.png)

![alt text](/static/images/demon-11.png)

![alt text](/static/images/demon-12.png)
...
check_wish
![alt text](/static/images/demon-13.png)
...
![alt text](/static/images/demon-14.png)
